...
_Generated 2026-05-01T14:33:02.177933 from `logs/final/results.json` (227 experiments)_
## Executive summary
...
| 12 | `T1.4or5_mask_contrastive_supcon_at-test_30d` | **0.6637** | 0.5911 | 0.7363 | — | — |
...
Cross-config sample: **127 configurations for `at`** and **125 for `isAt`**, all on the 352-instance `at`-task test split. The set is the union of LLM zero-shot variants, RAG configurations, MASK feature variants, and handcrafted RF (smoke tests excluded).

### Hardness summary (352 instances per target)

| metric | `at` (127 configs) | `isAt` (125 configs) |
|---|---|---|
...
| 8 | `T1.4or5_mask_contrastive_supcon_at-test_30d` | 0.697 | 0.846 |
| … | _(remaining 205 configs cluster lower; see `logs/final/disagreement/summary.json` for the full table)_ |  |  |
...
- `T1.4or5_mask_contrastive_CEonly_at-test_30d`
...
- `T1.4or5_mask_contrastive_ordinal_m1_at-test_30d`
- `T1.4or5_mask_contrastive_supcon_at-test`
- `T1.4or5_mask_contrastive_supcon_at-test_30d`
